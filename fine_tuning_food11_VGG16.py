...
# plot the histogram of food classes distribution
...
p = [args["output"], "Food11_Data_Class_Distribution_{}_{}.png".format(spreproc,
                                                     os.getpid())]
...
# plot the histogram of food classes distribution training
...
p = [args["output"], "Food11_Data_Class_Distribution_for_train_set_{}_{}.png".format(spreproc,os.getpid())]
plt.savefig(os.path.sep.join(p))
plt.show()


# plot the histogram of food classes distribution testing
...
p = [args["output"], "Food11_Data_Class_Distribution_for_test_set_{}_{"
                     "}.png".format(spreproc,
                                    os.getpid())]
plt.savefig(os.path.sep.join(p))
plt.show()
...
# And now a few sample images from food11 dataset
...
p = [args["output"], "Food11_Data_Class_Samples_{}_{"
                     "}.png".format(spreproc,
                                    os.getpid())]
plt.savefig(os.path.sep.join(p))
plt.show()
...
print(report)
# Confusion Matrix
confmatrix = confusion_matrix(testY.argmax(axis=1), predictions.argmax(
  axis=1))
print(confmatrix)

# save the classification report and confussion matrix to file
